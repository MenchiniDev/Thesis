...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Output rumoroso pre-tuning}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{imgs/05_perception_pipeline/raw_dbscan1.png}
        \caption{Output stabile post-tuning}
    \end{subfigure}
    \caption{Effetto del fine-tuning su dati reali. (a) Parametri non ottimizzati generano cluster frammentati e rumorosi. (b) I parametri ottimali ($\varepsilon=0.22, \text{samples}=18$) producono una stima coerente della pendenza.}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Output stabile post-tuning}
    \end{subfigure}
    \caption{altri esempi di risultati della pipeline geometrica su dati reali dopo il fine-tuning dei parametri DBSCAN. come si vede la segmentazioe degli ostacoli è più nitida e coerente.}
    \label{fig:real_tuning}
\end{figure}
