...
\textit{[Questa sezione è riservata all'analisi comparativa tra il metodo DBSCAN+RANSAC e la baseline Kinect-based, con focus su metriche di clustering e tempi di esecuzione su hardware embedded.]}
